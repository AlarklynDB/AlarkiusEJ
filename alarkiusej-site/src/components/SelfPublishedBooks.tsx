          ...
          <div key={book.key} className="w-full max-w-xs">
            ...
            {'ebookLink' in book && book.ebookLink && (
              <a
                ...
                className="mt-3 flex w-fit mx-auto items-center justify-center gap-2 px-[63px] py-[15px] rounded-none text-sm font-semibold bg-surface-raised border border-border text-text hover:border-border-light hover:bg-ink-light transition-colors duration-200"
              >
