    ...
    <div className="min-h-screen bg-[#100908] text-[#c8c2ba] px-6 py-12 max-w-4xl mx-auto">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-3">
          {[
            { era: "The Greungerian Era (Ancient Era)", date: "10,000 OD – 500 OD", desc: "This was when the continents were still a massive landmass before the split. A meteor came from space at 501 OD and split the continents. It took nearly 200 years for the continents to settle into the current shape Modern Hetra stands on." },
