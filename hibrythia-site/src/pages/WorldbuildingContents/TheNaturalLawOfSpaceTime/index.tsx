  ...
  return (
    <div className="max-w-[960px] mx-auto px-6 py-20 space-y-16">
          ...
          <div className="border border-[#2e2b26] bg-[#0f0d0c] rounded-sm overflow-hidden">
            {idibs_rank.map((item, i) => (
              <div key={i} className="flex items-center gap-4 px-4 py-2.5 border-b border-[#1a1714] last:border-0">
                ...
                <p className="font-body text-sm text-[#c8c2ba]">{item}</p>
              </div>
            ))}
          </div>
          <p className="font-body text-sm text-[#c8c2ba] leading-relaxed">
      ...
      <section className="space-y-6">
        ...
        <p className="font-body text-sm text-[#7a746e]">Objects that pose no serious threat.</p>
        ...
        <div className="space-y-3">
          ...
          <p className="font-body text-sm text-[#7a746e]">In very rare cases, these bubbles can land on incoming asteroids or meteors, which turns them into habitual lands, given the right circumstances:</p>
          <div className="border border-[#2e2b26] bg-[#0f0d0c] rounded-sm overflow-hidden">
        ...
        <div className="border border-[#2e2b26] bg-[#0f0d0c] rounded-sm p-5 space-y-3">
          ...
          <div className="space-y-3 mt-2">
            <div className="flex gap-3 items-start">
              ...
              <p className="font-body text-sm text-[#c8c2ba] leading-relaxed"><span className="text-[#f2ebeb] font-medium">What it absorbs:</span> Deteriorated matter, corrupted particles, decayed stardust, and depleted elemental energy that has lost its stability over time. It does <em>not</em> absorb living objects, planets with active orbital planes, or stars in active fusion. There seems to be a natural boundary that protects these things &mdash; scientists and scholars of Hetra have called this the <em>Passive Threshold.</em></p>
            </div>
            <div className="flex gap-3 items-start">
              <span className="text-[#c9a84c] font-display text-sm mt-0.5 shrink-0">&mdash;</span>
              <p className="font-body text-sm text-[#c8c2ba] leading-relaxed"><span className="text-[#f2ebeb] font-medium">What it expels:</span> Pure, restored versions of the periodic elements &mdash; clean Hydrogen, clean Helium, untainted Carbon &mdash; scattered gently into the surrounding void. This is what gives the regions near a White Buffer unusually rich elemental density, making them prime zones for new star formation.</p>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-5">
        ...
        <div className="border border-[#2e2b26] bg-[#0f0d0c] rounded-sm p-5 space-y-3">
          ...
          <p className="font-body text-sm text-[#7a746e]">There are a lot of dark versions of Elemental Matter:</p>
      ...
      <section className="space-y-5">
        ...
        <div className="border border-[#2e2b26] bg-[#0f0d0c] rounded-sm p-5 space-y-3">
          ...
          <div className="flex gap-3 items-start pt-1">
            <span className="text-[#c9a84c] font-display text-sm mt-0.5 shrink-0">&mdash;</span>
            <p className="font-body text-sm text-[#c8c2ba] leading-relaxed">These parasites can help produce water and carbon, using their special ability called &ldquo;Atomic Production&rdquo;</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="border border-[#2e2b26] bg-[#0f0d0c] rounded-sm p-5 space-y-3">
          ...
          <div className="flex gap-3 items-start">
            <span className="text-[#c9a84c] font-display text-sm mt-0.5 shrink-0">&mdash;</span>
            <p className="font-body text-sm text-[#c8c2ba] leading-relaxed">These rocks are in a constant state between magma, plasma, water made of neutral elements.</p>
          </div>
          <p className="font-body text-sm text-[#c8c2ba] leading-relaxed">
