    ...
    <div className="min-h-screen px-6 py-16 max-w-[760px] mx-auto">
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <h2 className="font-display text-xl text-[#f2ebeb] mb-4">Hetranian Direwolves</h2>
        ...
        <section>
          ...
          <h2 className="font-display text-xl text-[#f2ebeb] mb-4">Wulfwing Direwolves</h2>
          <p className="font-body text-sm text-[#c8c2ba] leading-[1.85] mb-4">
          ...
          <h3 className="font-display text-lg text-[#f2ebeb] mb-4">Wulfwing Abilities</h3>
          ...
          <div className="space-y-4 mb-8">
            <h4 className="font-display text-base text-[#f2ebeb]">Defensive Abilities</h4>
            {[
          ...
          <div className="space-y-4 mb-8">
            <h4 className="font-display text-base text-[#f2ebeb]">Passive Abilities</h4>
            {[
          ...
          <h3 className="font-display text-lg text-[#f2ebeb] mb-4">Gender Identification — Wulfwing</h3>
          <p className="font-body text-sm text-[#c8c2ba] leading-[1.85] mb-4">
        ...
        <section>
          ...
          <h2 className="font-display text-xl text-[#f2ebeb] mb-4">Coppercrest Direwolves</h2>
          <p className="font-body text-sm text-[#c8c2ba] leading-[1.85] mb-4">
          ...
          <h3 className="font-display text-lg text-[#f2ebeb] mb-4">Coppercrest Abilities</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <p className="font-display text-base text-[#f2ebeb] mb-1">Copper Bite Contamination</p>
