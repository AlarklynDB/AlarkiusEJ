  ...
  return (
    <div className="min-h-screen px-6 py-16 max-w-[760px] mx-auto">
      ...
      <div className="space-y-12">
        ...
        {/* Terminology */}
        <section>
          <h2 className="font-display text-xl text-[#f2ebeb] mb-5">Terminology</h2>
          <div className="border border-[#2e2b26] rounded-sm bg-[#0f0d0c] px-5 py-5 mb-6">
            <p className="font-display text-lg text-[#f2ebeb] mb-1">Nhuemyns</p>
        ...
        <section>
          ...
          <h2 className="font-display text-xl text-[#f2ebeb] mb-2">What kinds of Nhuemyns are there?</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Humans</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Dragonkin */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Dragonkin (demi/half)</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Cyborgs */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Cyborgs</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Dwarfs */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Dwarfs</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Dryads */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Dryads</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Elves */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Elves</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Familia / Familiars */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Familia / Familiars</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Half Demon */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Half Demon (Lesser Kind)</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Mystical Dryads */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Mystical Dryads</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Nezphels */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Nezphels</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Sylphs */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Sylphs</h3>
            ...
            {/* Lizardmen */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Lizardmen / Lizardfolk</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Oceanfolk / Merfolk */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Oceanfolk / Merfolk</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85]">
            ...
            {/* Zytkx Humanoid */}
            <div className="border-l-2 border-[#2e2b26] pl-5">
              <h3 className="font-display text-lg text-[#f2ebeb] mb-2">Zytkx Humanoid</h3>
              <p className="font-body text-sm text-[#c8c2ba] leading-[1.85] mb-3">
