...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#ffd080' }}>Megacorps & Brands</span>
    </nav>
  )
}
    ...
    <div className="page-container">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <h2 className="font-serif text-3xl mb-2" style={{ color: '#ffd080' }}>Megacorps & Brands</h2>
          <p className="text-text-faint font-mono text-sm italic max-w-xl">The corporations and brands that shape Neo-Japan's economy.</p>
        </div>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        <div><Link to="/lore/the-world-of-neo-japan/education-in-neo-japan" className="btn-neon-cyan text-xs">← Education</Link></div>
