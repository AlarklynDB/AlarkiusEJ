  ...
  return (
    <div className="page-container">
      ...
      <div className="flex justify-between mt-12 pt-6 border-t border-border">
        <Link to="/lore/the-world-of-neo-japan/education-in-neo-japan" className="btn-neon-cyan text-sm px-4 py-2 rounded">
          ← Education
        </Link>
        <Link to="/lore/the-world-of-neo-japan" className="btn-neon-purple text-sm px-4 py-2 rounded">
