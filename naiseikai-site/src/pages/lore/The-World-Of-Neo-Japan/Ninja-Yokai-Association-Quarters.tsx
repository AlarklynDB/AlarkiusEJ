  ...
  return (
    <div className="page-container">
      ...
      <div className="flex justify-between mt-8 pt-6 border-t border-border">
        <Link to="/lore/the-world-of-neo-japan/yokai-association-recovery-center" className="btn-neon-cyan text-sm px-4 py-2 rounded">
          ← YARC
        </Link>
        <Link to="/lore/the-world-of-neo-japan/education-in-neo-japan" className="btn-neon-purple text-sm px-4 py-2 rounded">
          Education →
        </Link>
      </div>
