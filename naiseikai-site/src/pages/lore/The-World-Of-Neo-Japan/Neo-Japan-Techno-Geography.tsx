...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#7ef5ff' }}>Techno-Geography</span>
    </nav>
  )
}
...
export default function Neo-Japan-Techno-GeographyPage() {
  return (
    <div className="page-container">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <h2 className="font-serif text-3xl mb-2" style={{ color: '#7ef5ff' }}>Techno-Geography</h2>
          <p className="text-text-faint font-mono text-sm italic max-w-xl">The physical and technological landscape of Neo-Japan.</p>
        </div>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        ...
        <div>
          <Link to="/lore/the-world-of-neo-japan/neo-japan-prefectures" className="btn-neon-cyan text-xs">Prefectures of Neo-Japan →</Link>
        </div>
      </div>
    </div>
  )
