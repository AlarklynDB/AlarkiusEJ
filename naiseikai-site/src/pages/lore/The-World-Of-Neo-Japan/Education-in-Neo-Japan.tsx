  ...
  return (
    <div className="page-container">
      ...
      <p className="text-base text-text-muted leading-relaxed mb-4">
        ...
        <Link to="/lore/the-world-of-neo-japan/religion-of-ujuukyo" className="underline" style={{ color: ACCENT }}>Ujuukyo</Link>!
      </p>
      ...
      <p className="text-base text-text-muted leading-relaxed mb-4">
        ...
        <Link to="/lore/the-world-of-neo-japan/ninja-yokai-association-quarters" className="underline" style={{ color: ACCENT }}>NYAQ</Link>{' '}
      ...
      <p className="text-base text-text-muted leading-relaxed mb-4">
        ...
        <Link to="/lore/the-world-of-neo-japan/religion-of-ujuukyo" className="underline" style={{ color: ACCENT }}>Ujuukyo's Religion</Link>,
      ...
      <div className="flex justify-between mt-8 pt-6 border-t border-border">
        <Link to="/lore/the-world-of-neo-japan/ninja-yokai-association-quarters" className="btn-neon-cyan text-sm px-4 py-2 rounded">
          ← NYAQ
        </Link>
        <Link to="/lore/the-world-of-neo-japan/megacorps-and-brands" className="btn-neon-purple text-sm px-4 py-2 rounded">
          Megacorps &amp; Brands →
        </Link>
      </div>
