...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#d49fff' }}>Education in Neo-Japan</span>
    </nav>
  )
}
    ...
    <div className="page-container">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <h2 className="font-serif text-3xl mb-2" style={{ color: '#d49fff' }}>Education in Neo-Japan</h2>
          <p className="text-text-faint font-mono text-sm italic max-w-xl">The schooling system in 2100 Alt-Earth Japan.</p>
        </div>
