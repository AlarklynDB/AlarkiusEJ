...
function SubHeading({ children }: { children: React.ReactNode }) {
  return (
    <h3 className="text-lg font-semibold mt-5 mb-1" style={{ color: ACCENT }}>
      {children}
    </h3>
  );
}
...
export default function ReligionOfUjuukyo() {
  return (
    <div className="lore-page-container max-w-4xl mx-auto px-4 py-8 text-white">
      ...
      {/* ── Intro Block ── */}
      <div
        className="callout mt-8 mb-6 rounded-lg p-5"
        style={{ borderLeft: `4px solid ${ACCENT}`, background: '#1a1508' }}
      >
        <p className="text-base font-medium mb-1" style={{ color: ACCENT }}>
          私たちはあなたの沈黙に答えます。ようこそ。
        </p>
        <p className="italic text-sm opacity-70 mb-1">
          Watashitachi wa anata no chinmoku ni kotaemasu. Yōkoso.
        </p>
        <p className="italic text-sm opacity-70 mb-3">
          We will respond to your silence. Welcome in.
        </p>
        <p className="text-sm opacity-80">You are safe here. Welcome home.</p>
      </div>
      ...
      <p className="text-sm opacity-70 mb-3 italic">Sacred Titles:</p>
      ...
      <p className="text-sm opacity-70 mb-2 font-semibold">Pre-requisites:</p>
      <ul className="list-disc list-inside space-y-1 mb-4 text-sm">
        <li>
          Drench (Baptize) head with Sakura Water — symbolizes thought and purity
        </li>
        <li>
          Wash and Clean the Feet — symbolizes the pathway you've walked
        </li>
      </ul>
      ...
      <div
        ...
        style={{ background: '#1a1508', border: `1px solid ${ACCENT}44` }}
      >
        <p className="italic text-sm opacity-80">Core Maxims:</p>
        <p className="italic text-sm" style={{ color: ACCENT }}>
          "Silence is not absence. It is the fullness of presence."
        </p>
        <p className="italic text-sm" style={{ color: ACCENT }}>
          "Death is not an end. It is the doorway discernment walks through last."
        </p>
        <p className="italic text-sm" style={{ color: ACCENT }}>
          "Mercy does not speak loudly. It listens until the world quiets down."
        </p>
        <p className="italic text-sm" style={{ color: ACCENT }}>
          "Value yourself. Honor others. Hold silence like a gift."
        </p>
      </div>
      ...
      <p
        className="text-base font-semibold mt-4 mb-6"
        style={{ color: ACCENT }}
      >
      ...
      <p className="text-sm opacity-70 mb-2 font-semibold">The Five Pillars:</p>
      ...
      {[
        ...
        },
        {
          ...
          title: 'Storm of Unbound Rage',
          sacred: 'Anger',
          disparity: 'Destroys without discernment',
          balance: 'Stillness and Mercy',
        },
        {
          kanji: '羨望の毒',
          romaji: 'Senbou no Doku',
          title: 'Poison of Bitter Envy',
          sacred: 'Desire to grow',
          disparity: 'Bitter envy',
          balance: 'Acceptance and gratitude',
        },
        {
          kanji: '欲望の鎖',
          romaji: 'Yokubou no Kusari',
          title: 'Chains of Selfish Desire',
          sacred: 'Attraction',
          disparity: 'Dishonors autonomy',
          balance: 'Honor and respect',
        },
        {
          kanji: '貪欲の闇',
          romaji: 'Donyoku no Yami',
          title: 'Darkness of Hoarding',
          sacred: 'Security',
          disparity: 'Greed',
          balance: 'Generosity and trust',
        },
        {
          kanji: '過剰の迷い',
          romaji: 'Kajou no Mayoi',
          title: 'Confusion of Excess',
          sacred: 'Joy',
          disparity: 'Excess without discernment',
          balance: 'Discernment and Ma (間)',
        },
        {
          kanji: '無関心の霧',
          ...
          sacred: 'Rest',
          disparity: 'Apathy',
          balance: 'Diligence and engagement',
        },
      ].map((d) => (
        <div
          key={d.kanji}
          className="rounded-lg p-5 mb-4"
          style={{ background: '#1a1508', border: `1px solid ${ACCENT}55` }}
        >
          <p className="text-xl font-bold mb-0.5" style={{ color: ACCENT }}>
            {d.kanji}
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-sm">
            <div>
              <span className="opacity-50 block text-xs uppercase tracking-widest mb-0.5">Sacred Emotion</span>
              <span>{d.sacred}</span>
            </div>
            <div>
              <span className="opacity-50 block text-xs uppercase tracking-widest mb-0.5">The Disparity</span>
              <span>{d.disparity}</span>
            </div>
            <div>
              <span className="opacity-50 block text-xs uppercase tracking-widest mb-0.5">Path to Balance</span>
      ...
      <div
        ...
        style={{ background: '#1a1208', border: `1px solid ${ACCENT}` }}
      >
        <p className="text-lg font-bold mb-1" style={{ color: ACCENT }}>
          正義のための報復
        </p>
        <p className="text-sm italic opacity-60 mb-3">
          Seigi no tame no hōfuku — Retribution for Justice / Righteous Revenge
        </p>
        <p className="text-base leading-relaxed">
          Neither disparity nor sacred emotion. The Hidden Balance. Free will when roped into conflict. Ujuu-sama does not mind, as long as it feels <em style={{ color: ACCENT }}>right.</em>
        </p>
      </div>
      ...
      <ol className="list-decimal list-inside space-y-2 mb-6 text-base">
      ...
      <div
        className="rounded-lg p-5 mb-10 text-center"
        style={{ background: '#1a1508', border: `1px solid ${ACCENT}44` }}
      >
      ...
      <div className="flex justify-between mt-8 pt-6 border-t border-white/10">
        <Link
          to="/lore/the-world-of-neo-japan/yokai-citizens-of-neo-japan"
          className="btn-neon-cyan text-sm px-4 py-2 rounded"
        >
          ← Yokai Citizens
        </Link>
        <Link
          to="/lore/the-world-of-neo-japan/yhca-yokaihuman-coalition-act"
          className="btn-neon-purple text-sm px-4 py-2 rounded"
        >
          YHCA →
        </Link>
      </div>
