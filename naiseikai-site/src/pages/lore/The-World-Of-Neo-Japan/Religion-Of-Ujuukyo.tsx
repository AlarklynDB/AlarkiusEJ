...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#ffd080' }}>Religion of Ujuukyo</span>
    </nav>
  )
}
...
export default function Religion-Of-UjuukyoPage() {
  return (
    <div className="page-container">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <h2 className="font-serif text-3xl mb-2" style={{ color: '#ffd080' }}>Religion of Ujuukyo</h2>
          <p className="text-text-faint font-mono text-sm italic max-w-xl">The dominant spiritual faith of Neo-Japan.</p>
        </div>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        <div>
          <Link to="/lore/the-world-of-neo-japan/yokai-citizens-of-neo-japan" className="btn-neon-cyan text-xs">← Yokai Citizens</Link>
        </div>
        <Link to="/lore/the-world-of-neo-japan" className="text-xs font-mono text-text-faint hover:text-text transition-colors">
          ↑ All Topics
        </Link>
        <div>
          <Link to="/lore/the-world-of-neo-japan/yhca-yokaihuman-coalition-act" className="btn-neon-cyan text-xs">YHCA →</Link>
        </div>
      </div>
    </div>
  )
