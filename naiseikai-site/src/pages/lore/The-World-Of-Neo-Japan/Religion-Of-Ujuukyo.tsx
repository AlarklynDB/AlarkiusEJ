  ...
  return (
    <div className="page-container">
      ...
      <div className="flex justify-between mt-8 pt-6 border-t border-border">
        <Link to="/lore/the-world-of-neo-japan/yokai-citizens-of-neo-japan" className="btn-neon-cyan text-sm px-4 py-2 rounded">
          ← Yokai Citizens
        </Link>
        <Link to="/lore/the-world-of-neo-japan/yhca-yokaihuman-coalition-act" className="btn-neon-purple text-sm px-4 py-2 rounded">
          YHCA →
        </Link>
      </div>
