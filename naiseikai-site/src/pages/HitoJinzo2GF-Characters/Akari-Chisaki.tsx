...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#67e8f9' }}>Akari Chisaki</span>
    </nav>
  )
}
    ...
    <div className="page-container">
      ...
      <div className="space-y-8">
        <div>
          ...
          <h2 className="font-serif text-3xl mb-1" style={{ color: '#67e8f9' }}>Akari Chisaki</h2>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        <div><Link to="/titles/HitoJinzo2GF-LonelyAndroid/Ayane-Otokura" className="btn-neon-cyan text-xs">← Ayane Otokura</Link></div>
        <Link to="/titles/HitoJinzo2GF-LonelyAndroid" className="text-xs font-mono text-text-faint hover:text-text transition-colors">
          ↑ All Characters
        </Link>
        <div><Link to="/titles/HitoJinzo2GF-LonelyAndroid/Ayumi-Kazehara" className="btn-neon-purple text-xs">Ayumi Kazehara →</Link></div>
      </div>
    </div>
  )
}
