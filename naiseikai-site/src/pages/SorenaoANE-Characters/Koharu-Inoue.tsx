...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#ffb347' }}>Koharu Inoue</span>
    </nav>
  )
}
    ...
    <div className="page-container">
      ...
      <div className="space-y-8">
        <div>
          ...
          <h2 className="font-serif text-3xl mb-1" style={{ color: '#ffb347' }}>Koharu Inoue</h2>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        <div><Link to="/titles/SorenaoAne-Nevertheless/Shion-Nanako" className="btn-neon-cyan text-xs">← Shion Nanako</Link></div>
        <Link to="/titles/SorenaoAne-Nevertheless" className="text-xs font-mono text-text-faint hover:text-text transition-colors">
          ↑ All Characters
        </Link>
        <div><Link to="/titles/SorenaoAne-Nevertheless/Cyllvia-April" className="btn-neon-purple text-xs">Cyllvia April →</Link></div>
      </div>
    </div>
  )
}
