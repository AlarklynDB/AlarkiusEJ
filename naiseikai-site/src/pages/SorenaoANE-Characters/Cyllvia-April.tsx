...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#ffb347' }}>Cyllvia April</span>
    </nav>
  )
}
    ...
    <div className="page-container">
      ...
      <div className="space-y-8">
        <div>
          ...
          <h2 className="font-serif text-3xl mb-1" style={{ color: '#ffb347' }}>Cyllvia April</h2>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        <div><Link to="/titles/SorenaoAne-Nevertheless/Koharu-Inoue" className="btn-neon-cyan text-xs">← Koharu Inoue</Link></div>
